...
public class ManagementCheckoutBookingFragment extends AppCompatActivity {

    private ListView listView;
    private BookingCheckoutAdapter adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fragment_dashboard_checkout_bookings);
